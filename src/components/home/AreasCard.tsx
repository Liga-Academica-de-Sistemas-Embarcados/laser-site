...
function AreaChip({ title }: { title: string }) {
  return (
    <div className="flex items-center justify-center bg-[#E4E4E4] px-7 py-3 rounded-full">
...
export async function AreasCard({ solid }: ContentCardProps) {
  ...
  return (
    ...
    >
      <h2 className="font-[350] text-2xl md:text-3xl">{dict.home.areas["text-title"]}</h2>
      <div className="flex gap-5 flex-wrap justify-around max-w-lg">
        {
